...
namespace Preparcial.Vista
{
    public partial class FrmMain : Form
    {
        ...
        private void ActualizarOrdenesUsuario()
        {
            ...
            //CORRECIÓN: Se cambió "idarticulo" por "idArticulo" para que los productos cargaran en el combobox
            //Se debe a que en Modelo Inventario así se lama el atributo
            //CORRECIÓN: Se declaran los datos del combobox como nulos por costumbre
